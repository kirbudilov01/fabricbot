...
import { Search, Star, Users, ChevronRight, CreditCard, X, CheckCircle, StickyNote, MessageCircle, ChevronUp } from 'lucide-react'
    ...
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex space-x-6">
                <a href="/" className="text-primary-600 font-medium">Discover</a>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">EARN WITH OTHERS</h1>
          <p className="text-lg text-gray-600">Get referral links to other people's products and earn together</p>
        </div>
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-semibold text-gray-900 text-center mb-8">Now is featured</h2>
          {isLoadingOffers ? (
            ...
            <div className="flex gap-6 overflow-x-auto pb-4">
              {featuredOffers.map((offer) => (
                <div key={offer.id} className="flex-shrink-0 w-80 card p-0 overflow-hidden">
                  <Image
                    src={offer.coverUrl}
                    alt={offer.title}
                    width={320}
        ...
        <section>
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-semibold text-gray-900">Recent Creators</h2>
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 w-12 h-12 bg-primary-500 hover:bg-primary-600 text-white rounded-full shadow-lg flex items-center justify-center transition-colors z-50"
        >
      ...
      <Modal isOpen={payModal} onClose={() => setPayModal(false)} title="You are about to send">
        {selectedOffer && (
      ...
      <Modal isOpen={paymentSuccess} onClose={() => setPaymentSuccess(false)}>
